 ...
 */
export declare function isMissingTerminalEvent(chunk: StreamChunk): boolean;
/**
 ...
 */
export declare function fixTruncatedStream(upstream: AsyncIterable<StreamChunk>): AsyncIterable<StreamChunk>;
