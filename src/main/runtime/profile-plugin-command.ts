...
export function buildProfilePluginAddArguments(
  ...
  return [dshEntryPath, 'plugin', '--profile', PROFILE, 'add', pluginSpec]
}
...
export async function installProfilePluginWithDsh(
  options: ProfilePluginCommandOptions,
  pluginSpec: string,
  ...
  return runProfileCommand(
    options,
    buildProfilePluginAddArguments(options.dshEntryPath, pluginSpec),
