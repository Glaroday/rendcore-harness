...
export function aboutDetail(
  ...
  if (locale === 'zh') {
    return `RendCore Harness 版本：${desktopVersion}\n内置 Harness 版本：${harness}\n\nHarness 随 RendCore Harness 更新。`
  }
  return `RendCore Harness version: ${desktopVersion}\nBundled Harness version: ${harness}\n\nHarness is updated with RendCore Harness.`
}
