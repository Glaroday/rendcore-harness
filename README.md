<h1 align="center">
  <img src="docs/images/readme-logo-black-v020.png" width="64" alt="RendCore Harness logo" valign="middle" />
  RendCore Harness
</h1>
...
![RendCore Harness overview with portable presets, model providers, and phone control](docs/images/dsh-desktop-hero-v020.png)

<p align="center"><strong>RendCore Harness connects to online model providers and keeps your workspaces, sessions, and plugins local.</strong></p>

RendCore Harness packages the Harness web experience as a desktop application. It launches a local Harness instance automatically, manages a random loopback port, persists profiles, plugins, and sessions, and opens the full interface as soon as Harness is ready. Project workspaces are added and managed entirely in the Harness interface.

> [!IMPORTANT]
> RendCore Harness is currently an early preview and depends on the rapidly evolving Harness runtime. API keys are entered by the user and are never bundled in this repository. Installers and release notes are published in this GitHub repository.

## Download

Download RendCore Harness for macOS and Windows from the [GitHub Releases page](https://github.com/Glaroday/rendcore-harness/releases).
...
<p align="center">
  Scan the QR code below with WeChat to join the RendCore Harness community group.<br />
  <img src="docs/images/wechat-group-20260815.png" width="220" alt="RendCore Harness WeChat group QR code" /><br />
  Prefer Discord? <a href="https://discord.gg/he2gAKCpj">Join the RendCore Harness Discord community</a>.
</p>

## Why this project exists

The Harness runtime already provides a complete agent runtime and Web UI. RendCore Harness does not reimplement Harness; it supplies the host capabilities needed for a desktop product:
...
`npm install` runs `patch-package` to reapply RendCore's model-provider onboarding, preset package transfer, and sidebar branding, installs the brand asset, and then installs the Electron runtime.
...
```text
RendCore Harness (Electron Main)
...
The Harness runtime and its dependencies remain subject to their respective upstream licenses and trademark policies. RendCore Harness is an independent community desktop wrapper.
